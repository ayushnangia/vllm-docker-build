# Dockerfile for SGLang parent commit 45d6592d4053fe8b2b8dc9440f64c900de040d09
...
ARG SGLANG_COMMIT=45d6592d4053fe8b2b8dc9440f64c900de040d09
...
WORKDIR /sgl-workspace
CMD ["python3", "-c", "import sglang; print('SGLang parent loaded successfully')"]
